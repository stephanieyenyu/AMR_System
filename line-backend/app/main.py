...
async def admin_list_packages(
    ...
    if unit:
        query = query.filter(Package.unit.ilike(f"%{unit}%"))
...
# ADMIN_DASHBOARD_HTML 已遷移至 app/templates/dashboard.html + app/static/js/dashboard.js + app/static/css/dashboard.css
