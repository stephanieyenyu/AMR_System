...
FLASHBOT_SN=ROBOT_SERIAL_NUMBER
...
aurobox --sn # map-list
aurobox --sn # recharge
aurobox --sn # --shop-id YOUR_SHOP_ID open-map --map-name map1
aurobox --sn # --shop-id YOUR_SHOP_ID call --map-name map1 --point charging_point
```
